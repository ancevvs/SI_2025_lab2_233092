...
Во функцијата testEveryStatement се покриени тестови со кои секоја наредба е извршена барем еднаш, а со функцијата testMultipleCondition се покриени 8те тестови од табелата погоре. Тестовите ги проверував така што користев променлива res на која и ги доделував вредностите преку истите аритметички операции што се користат во функцијата checkCart.
